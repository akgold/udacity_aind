...
class TestCross(unittest.TestCase):
    ...
    def test_cross(self):
        self.assertTrue(solution.cross(self.letters, self.numbers) == ['A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'A9', 
        ...
        "Cross didn't work right")

class TestEliminate(unittest.TestCase):
    before_eliminate = {'A1': '9', 'A2': '123456789', 'A3': '6', 'A4': '123456789', 'A5': '123456789', 'A6': '123456789', 'A7': '123456789', 'A8': '2', 'A9': '123456789', 
    'B1': '123456789', 'B2': '2', 'B3': '123456789', 'B4': '8', 'B5': '123456789', 'B6': '123456789', 'B7': '123456789', 'B8': '123456789', 'B9': '123456789', 
    'C1': '7', 'C2': '5', 'C3': '123456789', 'C4': '9', 'C5': '123456789', 'C6': '3', 'C7': '123456789', 'C8': '4', 'C9': '6', 
    'D1': '8', 'D2': '123456789', 'D3': '3', 'D4': '1', 'D5': '9', 'D6': '123456789', 'D7': '7', 'D8': '123456789', 'D9': '5', 
    'E1': '123456789', 'E2': '123456789', 'E3': '5', 'E4': '123456789', 'E5': '123456789', 'E6': '123456789', 'E7': '4', 'E8': '123456789', 'E9': 
    '123456789', 'F1': '6', 'F2': '123456789', 'F3': '2', 'F4': '123456789', 'F5': '4', 'F6': '5', 'F7': '1', 'F8': '123456789', 
    'F9': '3', 'G1': '4', 'G2': '1', 'G3': '123456789', 'G4': '2', 'G5': '123456789', 'G6': '9', 'G7': '123456789', 
    'G8': '3', 'G9': '8', 'H1': '123456789', 'H2': '123456789', 'H3': '123456789', 'H4': '123456789', 
    'H5': '123456789', 'H6': '4', 'H7': '123456789', 'H8': '1', 'H9': '123456789', 'I1': '123456789', 
    'I2': '6', 'I3': '123456789', 'I4': '123456789', 'I5': '123456789', 'I6': '123456789', 'I7': '2', 
    'I8': '123456789', 'I9': '4'}
    soln = {'A1': '9', 'A2': '348', 'A3': '6', 'A4': '457', 'A5': '157', 'A6': '17', 'A7': '358', 'A8': '2', 'A9': '17'}

    def test_eliminate(self):
        solved = solution.eliminate(self.before_eliminate)
        eliminated = {k:solved[k] for k in self.soln.keys()} 
        self.assertTrue(eliminated == self.soln, 
            dict(zip(self.soln.values(), eliminated.values())))

class TestOnlyChoice(unittest.TestCase):
    before_only_choice = {'A1': '23456789', 'A2': '23456789', 'A3': '23456789', 'A4': '23456789', 
    'A5': '23456789', 'A6': '23456789', 'A7': '23456789', 'A8': '23456789', 'A9': '123456789', 
    'B1': '123456789', 'B2': '123456789', 'B3': '123456789', 'B4': '123456789', 'B5': '123456789', 
    'B6': '123456789', 'B7': '123456789', 'B8': '123456789', 'B9': '123456789', 'C1': '123456789', 
    'C2': '123456789', 'C3': '123456789', 'C4': '123456789', 'C5': '123456789', 'C6': '123456789', 
    'C7': '123456789', 'C8': '123456789', 'C9': '123456789', 'D1': '123456789', 'D2': '123456789', 
    'D3': '123456789', 'D4': '123456789', 'D5': '123456789', 'D6': '123456789', 'D7': '123456789', 
    'D8': '123456789', 'D9': '123456789', 'E1': '123456789', 'E2': '123456789', 'E3': '123456789', 
    'E4': '123456789', 'E5': '123456789', 'E6': '123456789', 'E7': '123456789', 'E8': '123456789', 
    'E9': '123456789', 'F1': '123456789', 'F2': '123456789', 'F3': '123456789', 'F4': '123456789', 
    'F5': '123456789', 'F6': '123456789', 'F7': '123456789', 'F8': '123456789', 'F9': '123456789', 
    'G1': '123456789', 'G2': '123456789', 'G3': '123456789', 'G4': '123456789', 'G5': '123456789', 
    'G6': '123456789', 'G7': '123456789', 'G8': '123456789', 'G9': '123456789', 'H1': '123456789', 
    'H2': '123456789', 'H3': '123456789', 'H4': '123456789', 
    'H5': '123456789', 'H6': '123456789', 'H7': '123456789', 'H8': '123456789', 'H9': '123456789', 
    'I1': '123456789', 'I2': '123456789', 'I3': '123456789', 'I4': '123456789', 'I5': '123456789', 
    'I6': '123456789', 'I7': '123456789', 'I8': '123456789', 'I9': '123456789'}
    soln = {'A1': '23456789', 'A2': '23456789', 'A3': '23456789', 'A4': '23456789', 
    'A5': '23456789', 'A6': '23456789', 'A7': '23456789', 'A8': '23456789', 'A9': '1', 
    'B1': '123456789', 'B2': '123456789', 'B3': '123456789', 'B4': '123456789', 'B5': '123456789', 
    'B6': '123456789', 'B7': '123456789', 'B8': '123456789', 'B9': '123456789', 'C1': '123456789', 
    'C2': '123456789', 'C3': '123456789', 'C4': '123456789', 'C5': '123456789', 'C6': '123456789', 
    'C7': '123456789', 'C8': '123456789', 'C9': '123456789', 'D1': '123456789', 'D2': '123456789', 
    ...
    'I6': '123456789', 'I7': '123456789', 'I8': '123456789', 'I9': '123456789'}
    def test_eliminate(self):
        solved = solution.only_choice(self.before_only_choice)
        self.assertTrue(solved == self.soln, 
            solved)        
